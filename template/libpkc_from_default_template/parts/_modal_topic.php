	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><?php echo __('Select the topic you are interested in'); ?></h5>
				...
				<ul class="topic d-flex flex-wrap justify-content-center p-0">
					<li class="d-flex justify-content-center align-items-center m-2">
						<a href="index.php?callnumber=0&search=search" class="d-flex flex-column">
							...
							<?php echo __('Computer science, information & general works'); ?>
						</a>
					</li>
					<li class="d-flex justify-content-center align-items-center m-2">
						<a href="index.php?callnumber=1&search=search" class="d-flex flex-column">
							<img src="<?php echo assets('images/1-memory.png'); ?>" width="80" class="mb-3 mx-auto"/>
							<?php echo __('Philosophy & psychology'); ?>
						</a>
					</li>
					<li class="d-flex justify-content-center align-items-center m-2">
