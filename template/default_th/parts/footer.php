    ...
    <div class="container">
        <div class="row py-4">
            <div class="col-md-3">
                ...
                <ul class="list-reset">
                    <li><a class="text-light" href="index.php?p=libinfo">เกี่ยวกับห้องสมุด</a></li>
                    <li><a class="text-light" href="index.php?p=services">การบริการ</a></li>
                    <!-- <li><a class="text-light" href="index.php?p=librarian">Librarian</a></li> -->
                    <li><a class="text-light" href="index.php?p=member">มุมสมาชิก</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-4 pt-8 md:pt-0">
                <h4 class="mb-4">ค้นหา</h4>
                <div class="mb-2">สามารถค้นหาได้จาก ชื่อหนังสือ, ผู้แต่ง ฯลฯ</div>
                <!-- <div class="mb-2">start it by typing one or more keywords for title, author or subject</div> -->
                <form action="index.php">
                    <div class="input-group mb-3">
                        <input name="keywords" type="text" class="form-control" placeholder="ใส่คำค้นหา"
                               aria-label="Enter keywords"
                               aria-describedby="button-addon2">
                        <div class="input-group-append">
                            <button class="btn btn-primary" type="submit" value="search" name="search"
                                    id="button-addon2">ค้นหา
                            </button>
                        </div>
                    </div>
                </form>
                ...
                <a target="_blank" title="Support Us" class="btn btn-outline-success mb-2"
                   href="https://slims.web.id/web/pages/support-us/"><i
                            class="fas fa-heart mr-2"></i><?= __('สนับสนุน SLiMS'); ?></a>
                <a target="_blank" title="Contribute" class="btn btn-outline-light mb-2"
                   href="https://github.com/slims/"><i
                            class="fab fa-github mr-2"></i><?= __('อยากช่วยพัฒนา SLiMS?'); ?></a>
            </div>
        </div>
        <hr>
